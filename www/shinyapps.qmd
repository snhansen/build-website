...
* Man kan under *Measurement error applied to X/Y-values* bestemme om målefejlen kun skal pålægges en delmængde af observationerne.
...
Her genereres en række QQ-plots fra en normalfordeling med den valgte stikprøvestørrelse. Dette kan bruges til at sammenligne sit eget QQ-plot med disse for at vurdere om det er rimeligt at antage, at data kan beskrives med en normalfordeling.
